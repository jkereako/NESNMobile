...
@class CSCensus, CSNotificationsObserver, CSOfflineCache, CSDispatchQueue, CSStorage, CSKeepAlive;
@class CSTaskExecutor, CSMeasurementDispatcher;
...
@interface CSCore : NSObject {
    ...
    BOOL _networkConnectivityListenerStarted;
    BOOL _firstCheckForInternetConnectivityChangePerformed;

    CSStorage *_storage;
    CSDispatchQueue *_dispatchQueue;
